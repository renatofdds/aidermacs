...
(transient-define-prefix aidermacs-transient-menu ()
  ...
  ["aidermacs: AI Pair Programming"
   ["aidermacs Process"
    ...
    ("a" "Run aidermacsmacs" aidermacs-run-aidermacs)
    ("z" "Switch to aidermacsmacs Buffer" aidermacs-switch-to-buffer)
    ("o" "Select Model" aidermacs-change-model)
    ("l" "Clear aidermacsmacs" aidermacs-clear)
    ("s" "Reset aidermacsmacs" aidermacs-reset)
    ("x" "Exit aidermacsmacs" aidermacs-exit)
    ]
